...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        # General
        parser.add_argument('--demo-folder', type=str, default='/kaggle/input/synboostwo-data-generator/final_dataset/fs_lost_and_found/original', help='path to the folder containing demo images',
                            required=False)
