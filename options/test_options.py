...
class TestOptions(BaseOptions):
    def initialize(self, parser):
        ...
        # General
        parser.add_argument('--demo-folder', type=str, default='/kaggle/input/synboostwo-data-generator/final_dataset/road_anomaly/original', help='path to the folder containing demo images',
                            required=False)
